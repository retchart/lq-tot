...
//              A FIFO is needed for transmit data.
//Ethenet II frame:
// |0          15|       23|      31|
...
udp_tx_data_fifo tx_data_fifo
 ...
 always @(posedge clk or negedge rst_n)
  ...
  //*****************************************************************************************//
  parameter CK_IDLE           = 6'b000001 ;
  parameter HEADER_CHECKSUM   = 6'b000010 ;
  parameter GEN_CHECKSUM      = 6'b000100 ;
  parameter GEN_ODD_CHECKSUM  = 6'b001000 ;
  parameter GEN_CHECKSUM_END  = 6'b010000 ;
  parameter CHECKSUM_WAIT     = 6'b100000 ;
